        ...
        <section id='#home'>
            <div className='hero w-[100%] h-[500px]'>
                <div className='w-[100%] md:w-[50%] h-[100%] flex flex-col pt-[30px] md:pt-0 md:justify-center items-center'>
                    ...
                    <a onClick={() => { window.open('https://wa.me/918129387797') }} className='bg-[#08898F] pr-6 md:pr-14 pl-6 md:pl-14 pt-3 md:pt-4 pb-3 md:pb-4 rounded-lg text-white font-Inter font-normal md:font-medium' href="/">Book Now</a>
                </div >
